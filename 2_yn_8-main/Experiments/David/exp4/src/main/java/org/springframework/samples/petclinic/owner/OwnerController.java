...
class OwnerController {
    ...
    @RequestMapping(method = RequestMethod.PUT, path = "/owners/{id}")
    public Owners editOwner(
    ...
    @RequestMapping(method = RequestMethod.DELETE, path = "/owners/delete/{id}")
    public Optional<Owners> deleteOwner(@PathVariable("id") int id) {
    	Optional<Owners> ret = ownersRepository.findById(id);
    	ownersRepository.deleteById(id);
    	return ret;
    }
    
    @RequestMapping(method = RequestMethod.POST, path = "/owners")
    public Owners addOwner(@RequestBody Owners owner) {
    	ownersRepository.save(owner);
    	return owner;
    }
